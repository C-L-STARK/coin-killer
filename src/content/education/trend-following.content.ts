...
export const trendFollowingContent = {
  zh: {
<<<<<<< HEAD
    title: '趋势跟踪完整指南 - Trend Following策略与EMA均线系统 | BiKiller',
...
>>>>>>> fx-killer/main
    ...
    ctaTitle: '想要系统学习趋势交易？',
<<<<<<< HEAD
    ctaDescription: '加入 BiKiller 培训计划，获取专业趋势跟踪策略和趋势分析工具',
=======
...
>>>>>>> fx-killer/main
  ...
  en: {
<<<<<<< HEAD
    title: 'Complete Trend Following Guide - Strategies and EMA Moving Average System | BiKiller',
...
<<<<<<< HEAD
    ctaDescription: 'Join BiKiller training for professional trend following strategies and trend analysis tools',
=======
