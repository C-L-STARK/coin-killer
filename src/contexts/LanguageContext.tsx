...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'req.online.hours.desc': '24小时全天交易，灵活安排时间',
    'req.online.debrief': '团队复盘',
    'req.online.debrief.desc': '定期参加团队复盘和策略讨论',
    ...
    'footer.copyright': '© 币刃 · 专业数字货币交易员培训平台 · bikiller.com',
    ...
    'joinus.profile.time.1': '24小时全天交易，灵活安排时间',
    'joinus.profile.time.2': '定期参加团队复盘和策略讨论',
    ...
    'faq.category.course': '关于 BiKiller',
    ...
    'donate.how.step2.desc': '邮件至 bikiller.com@gmail.com，说明您的意向',
    ...
    'dashboard.footer.copyright': '2024-2025 © BiKiller 专业数字货币交易员培训平台',
    ...
    'blog.cta.subtitle': '加入BiKiller，接受专业的数字货币交易员培训',
  ...
  en: {
    ...
    // Hero Section
    'hero.title': 'Professional Crypto Trader Training Platform',
    'hero.subtitle': 'Precise, Professional, Efficient - Cultivating True Cryptocurrency Trading Experts',
    'hero.cta.learn': 'Learn About Crypto Training',
    'hero.cta.dashboard': 'Enter Trading System',

    // Why Choose Section
    'why.title': 'Why Choose BiKiller',
    'why.subtitle': 'Focused on selecting and cultivating elite cryptocurrency traders, nurturing those truly suited, retaining the few, and advising the majority to pursue other paths',

    // Advantages
    'advantage.selection.title': 'Precise Selection',
    'advantage.selection.desc': 'Within 30 working days, determine if cryptocurrency trading is your calling. If not suited, we\'ll be honest; if suited, we\'ll invest fully in your development.',
    'advantage.growth.title': 'Rapid Growth',
    'advantage.growth.desc': 'Scientifically avoid common pitfalls, allowing suited individuals to achieve in 30 working days what experts take 10-20 years to accomplish in crypto trading.',
    ...
    // Comparison
    'comparison.vs': 'VS Traditional Crypto Training',
    'comparison.fxkiller': 'BiKiller',
    ...
    'comparison.emphasis': 'We are dedicated to identifying, from a large population, the few individuals truly suited for cryptocurrency trading, and providing them with comprehensive development and support in the shortest timeframe possible.',

    // Career Path
    'career.title': 'Career Development Path',
    'career.subtitle': '30-Day Systematic Development: Complete Path from Novice to Professional Cryptocurrency Trader',
    'career.stage1.days': 'Days 1-5',
    'career.stage1.title': 'Rule Learning',
    'career.stage1.desc': 'Complete 15 standard entry point exercises, master fundamental crypto trading system rules',
    ...
    'career.stage2.desc': 'Find suitable trading pairs for yourself, practice according to profitability standards',
    ...
    'career.stage4.goal': ' Complete work time freedom, begin independent cryptocurrency trader career',

    // Requirements
    'req.title': 'Do You Meet Basic Requirements',
    'req.subtitle': 'Strict admission standards ensure crypto training quality - Everyone has only one opportunity to enter',
    ...
    'req.online.hours.desc': '24/7 Trading Available, Flexible Schedule',
    'req.online.debrief': 'Team Debrief',
    'req.online.debrief.desc': 'Regular participation in team debriefs and strategy discussions',
    ...
    // CTA Section
    'cta.title': 'Ready to Start Your Cryptocurrency Trading Career?',
    ...
    // Footer
    'footer.about': 'Professional cryptocurrency trader training platform focused on selecting and cultivating truly suited trading talent for crypto markets using professional methods.',
    ...
    'footer.copyright': '© BiKiller · Professional Cryptocurrency Trader Training Platform · bikiller.com',
    ...
    // Join Us Page
    'joinus.hero.badge': 'PROFESSIONAL TRADER TRAINING',
    'joinus.hero.title1': 'BiKiller',
    'joinus.hero.title2': 'Cryptocurrency Trader Training',
    ...
    'joinus.about.desc1': 'We are a training organization focused on selecting and cultivating elite cryptocurrency traders. We are committed to identifying, in the shortest time possible, the few individuals from a large population who are suited for crypto trading, and providing them with cultivation and support.',
    'joinus.about.desc2': 'Simply put, we are recruiting cryptocurrency traders—but not experienced traders with years in the field. Excellent traders don\'t circulate in the job market; they can only be cultivated personally. In other words, we personally select and train our traders, committed to developing qualified traders into fund managers.',
    'joinus.about.timeline': 'Within 45 days (30 working days), we will determine whether newcomers have the potential to become cryptocurrency traders:',
    ...
    'joinus.profile.unsuited': 'In the world of cryptocurrency trading, some people are inherently unsuited. They rush for success yet don\'t know what they truly seek; they glance at surfaces then stop, unable to perceive deeper truths. Or perhaps they should choose those "stable" positions—going through the motions, living predictable days. This isn\'t disparagement, but reality: crypto trading is a battlefield requiring composure, insight, and resilience. If this describes you, other industries may better suit your strengths.',
    ...
    'joinus.profile.time.1': '24/7 Trading Available, Flexible Schedule',
    'joinus.profile.time.2': 'Regular participation in team debriefs and strategy discussions',
    ...
    'joinus.plan.phase2.desc': 'Don\'t overthink; find trading pairs suitable for you',
    'joinus.plan.phase2.week1': 'Week 1: Practice extensively, find suitable trading pairs (start with 4-6 for observation, stabilize to 2 trading pairs)',
    ...
    'joinus.plan.phase4.1': 'Small-amount live trading maintains profit assessment requirements: 1-3 trading pairs, no missed entries, no missed exits, no losses',
    ...
    'faq.category.course': 'About BiKiller',
    ...
    'donate.how.step2.desc': 'Email to bikiller.com@gmail.com explaining your intention',
    ...
    // Email Contact Modal
    'email.default.title': 'Cryptocurrency Trader Interview',
    'email.subject': 'Cryptocurrency Trader Communication',
    ...
    'email.tip': 'Tip:',
    'email.tip.text': 'Please include your basic information, educational background, and why you want to become a cryptocurrency trader in your email.',
    'email.send': 'Open Email Client',
    'email.close': 'Close',

    // Trading Dashboard
    'dashboard.title': 'Crypto Trading Dashboard',
    'dashboard.subtitle': 'BTC/ETH Hybrid Strategy - Professional Trading System',
    ...
    'dashboard.footer.copyright': '2024-2025 © BiKiller Professional Cryptocurrency Trader Training Platform',
    ...
    // Subscription Notification
    'notification.message1': 'Contacted team leader to join cryptocurrency trader training',
    ...
    'blog.cta.subtitle': 'Join BiKiller for professional cryptocurrency trader training',
