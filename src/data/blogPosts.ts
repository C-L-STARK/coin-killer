...
export const blogPosts: BlogPost[] = [
 ...
 slug: 'about-bikiller',
 title: {
 zh: '关于币刃 (BiKiller) - 军事化数字货币交易员训练营',
 en: 'About BiKiller - Military-Style Cryptocurrency Trader Training Camp'
 },
 excerpt: {
 zh: '币刃 (BiKiller) 是一个专注于筛选和培养数字货币交易员的训练营。我们的理念：培养真正适合的人，留下极少数，劝返大多数。通过率10%-15%，30个工作日完整培训，盈利分成60%-90%。',
 en: 'BiKiller is a training camp focused on selecting and cultivating cryptocurrency traders. Our philosophy: cultivating those truly suited, retaining the few, advising the majority. Pass rate 10%-15%, 30 working days complete training, 60%-90% profit share.'
 },
 content: {
 zh: `<h1 class="text-4xl font-bold text-center mb-8 text-black dark:text-white">关于币刃 (BiKiller)</h1>

<p class="text-base leading-relaxed mb-8 text-center text-gray-700 dark:text-gray-300">币刃是一个专注于筛选和培养顶尖数字货币交易员的军事化训练营。我们不追求数量，只培养真正适合的人。这是一个严格、高强度、高淘汰率的专业训练项目。</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">币刃采用军事化管理模式，因为我们深知：交易是一场心理战争，需要极强的纪律性、执行力和心理素质。我们的培训不是教你如何快速致富，而是培养你成为一名专业的、可持续盈利的交易员。</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">币刃采用分润制度，你的收入完全取决于你的交易盈利。我们不收取任何培训费用，也不要求你投入自己的资金。公司提供配资，你只需专注于交易。</p>
...
<li class="text-white dark:text-black leading-relaxed flex items-start gap-2"><span class="font-bold">•</span><span>如有虚假信息，一经发现立即淘汰</span></li>
 ...
 en: `<h1 class="text-4xl font-bold text-center mb-8 text-black dark:text-white">About BiKiller (BiKiller)</h1>

<p class="text-base leading-relaxed mb-8 text-center text-gray-700 dark:text-gray-300">BiKiller is a military-style training camp focused on selecting and cultivating top cryptocurrency traders. We don't pursue quantity, only cultivating those truly suited. This is a strict, high-intensity, high-elimination professional training program.</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">BiKiller adopts a military-style management model because we know: trading is a psychological war requiring extreme discipline, execution, and mental strength. Our training isn't about teaching you how to get rich quick, but cultivating you to become a professional, sustainable trader.</p>
...
<p class="text-base leading-relaxed mb-6 text-gray-700 dark:text-gray-300">BiKiller is not just a training institution, but more like a highly disciplined military camp. We won't promise you quick riches or easy success. What we can provide is:</p>
...
<p class="text-lg text-center text-white dark:text-black">Email us: bikiller.com@gmail.com</p>
</div>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-3">同时做多BTC/USDT和ETH/USDT，以为是两笔交易，实际风险翻倍。</p>
<p class="text-sm font-bold text-black dark:text-white mb-2">正确做法：</p>
<p class="text-gray-600 dark:text-gray-400 text-sm">注意交易对的相关性，避免重复风险暴露。</p>
</div>
</div>
...
<ul class="space-y-2">
<li class="text-gray-600 dark:text-gray-400 text-sm flex items-start gap-2"><span class="text-black dark:text-white font-bold">•</span><span>在1.1000买入BTC/USDT，初始止损1.0950（50点）</span></li>
...
<p class="text-base leading-relaxed mb-8 text-center text-gray-700 dark:text-gray-300">Risk management is the cornerstone of successful trading. Master these principles to survive and thrive in the cryptocurrency market.</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-3">Don't put all your eggs in one basket. Spread risk across different trading pairs and avoid overexposure.</p>
<p class="text-sm font-bold text-black dark:text-white mb-2">Guidelines:</p>
<ul class="space-y-2">
<li class="text-gray-600 dark:text-gray-400 text-sm flex items-start gap-2"><span class="text-black dark:text-white font-bold">•</span><span>Maximum 30% of capital in a single trading pair</span></li>
<li class="text-gray-600 dark:text-gray-400 text-sm flex items-start gap-2"><span class="text-black dark:text-white font-bold">•</span><span>Maximum 50% in correlated pairs (BTC/USDT and ETH/USDT)</span></li>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-3">Going long on both BTC/USDT and ETH/USDT thinking they're two separate trades, but your risk is actually doubled.</p>
<p class="text-sm font-bold text-black dark:text-white mb-2">Correct Approach:</p>
<p class="text-gray-600 dark:text-gray-400 text-sm">Pay attention to trading pair correlations. Avoid duplicate risk exposure.</p>
</div>
</div>
...
<p class="text-sm font-bold text-black dark:text-white mb-2">Example:</p>
<ul class="space-y-2">
<li class="text-gray-600 dark:text-gray-400 text-sm flex items-start gap-2"><span class="text-black dark:text-white font-bold">•</span><span>Buy BTC/USDT at 1.1000, initial stop at 1.0950 (50 pips)</span></li>
...
<div class="bg-white dark:bg-gray-800 p-6 border-2 border-gray-200 dark:border-gray-700">
 ...
 <p class="text-base leading-relaxed mb-4 text-gray-700 dark:text-gray-300">Eurozone economic releases affect BTC/USDT, which influences gold prices</p>
 </div>
 </div>
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">💡 币刃推荐：波段交易策略</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">某币刃学员的真实交易记录（已脱敏）</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
...
<div class="bg-black dark:bg-white text-white dark:text-black p-8 mb-8 border-2 border-black dark:border-white">
<p class="text-2xl font-bold mb-4 text-white dark:text-black text-center">BiKiller Recommendation: Swing Trading Strategy</p>
...
<p class="text-gray-600 dark:text-gray-400 leading-relaxed mb-4">Real trading record from an BiKiller student (anonymized)</p>
<div class="overflow-x-auto">
<table class="w-full border-2 border-gray-300 dark:border-gray-700">
<thead>
<tr class="bg-gray-200 dark:bg-gray-800">
