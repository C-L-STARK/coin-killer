...
const getFAQData = (language: 'zh' | 'en'): FAQData => {
  if (language === 'zh') {
    return {
      course: [
        {
          question: '什么是 BiKiller 数字货币交易员培训？',
          answer: '我们是一个专注于筛选和培养顶尖数字货币交易员的专业培训平台。我们致力于用最短的时间从大量人群中筛选出少数适合做交易的人才并进行培养。我们将在<strong> 30个工作日</strong>内判断新人是否是做交易的可塑之才。通过考核者将获得资金支持,成为独立交易员或基金经理。'
        },
        {
          question: '为什么筛选如此严格？',
          answer: '我们的理念是<strong>培养真正适合的人，留下极少数，劝返大多数</strong>。在数字货币交易的世界里，有些人天生不适合。我们用严格的筛选机制确保只有真正适合的人才能进入。这不是贬低，而是对每个人负责——不让不适合的人在二级市场上成为韭菜。'
        },
        {
