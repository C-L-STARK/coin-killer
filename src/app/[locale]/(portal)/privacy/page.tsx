...
export default function PrivacyPolicyPage() {
  ...
  const content = {
    zh: {
      ...
      riskWarning: {
        title: "风险提示",
        content: "数字货币交易具有高风险，可能不适合所有投资者。杠杆交易可能导致快速且巨大的损失。请确保您充分了解相关风险，并在必要时寻求独立建议。本网站内容仅供教育和信息参考，不构成投资建议。"
      }
    },
    en: {
