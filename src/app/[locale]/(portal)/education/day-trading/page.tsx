      ...
      <section id="case-studies" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
            <h3 className="text-lg font-bold mb-3 text-black dark:text-white">
              {isZh ? '案例1：BTC/USDT趋势回调做多（H1图）' : 'Case 1: BTC/USDT Trend Pullback Long (H1 Chart)'}
            </h3>
            <div className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
              <p>
                <strong>{isZh ? '市场背景：' : 'Market Context:'}</strong>{' '}
                {isZh
                  ? '2024年1月10日，欧洲时段，BTC/USDT处于明确上升趋势，H4图显示价格持续在20EMA上方运行。'
                  : 'Jan 10, 2024, European session, BTC/USDT in clear uptrend, H4 chart shows price consistently above 20EMA.'}
              </p>
              <p>
          ...
          <div className="p-6 border-2 border-green-600 bg-green-50 dark:bg-green-900/20">
            <h3 className="text-lg font-bold mb-3 text-black dark:text-white">
              {isZh ? '案例2：ETH/USDT突破交易（M15图）' : 'Case 2: ETH/USDT Breakout Trade (M15 Chart)'}
            </h3>
            <div className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
              <p>
                <strong>{isZh ? '市场背景：' : 'Market Context:'}</strong>{' '}
                {isZh
                  ? '2024年1月12日，美洲时段，ETH/USDT在1.2700-1.2750区间震荡3小时后，突破上沿阻力。'
                  : 'Jan 12, 2024, American session, ETH/USDT ranging 1.2700-1.2750 for 3 hours, breaks above resistance.'}
              </p>
              <p>
                <strong>{isZh ? '入场分析：' : 'Entry Analysis:'}</strong>
              </p>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
            ...
            <p className="text-green-600 dark:text-green-400 font-bold">
              ✅ {isZh ? '正确做法：' : 'Solution:'}{' '}
              {isZh
                ? '计算"真实盈亏" = 毛利润 - 点差/手续费。选择低点差交易所（主流交易对点差<1点），避免在点差扩大时段交易（新闻、开盘）。如果使用M5/M15图表，目标利润应至少是点差的5-10倍（点差2点，目标至少10-20点）。考虑使用ECN账户降低成本。'
                : 'Calculate "true profit/loss" = gross profit - spread/commission. Choose low-spread exchanges (major pairs <1 pip), avoid trading during spread-widening periods (news, market open). If using M5/M15 charts, target profit should be at least 5-10x spread (2 pip spread, target minimum 10-20 pips). Consider using ECN account to reduce costs.'}
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="risk-management" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-1 text-sm">
                ...
                <li>{isZh ? '交易BTC/USDT（每标准手每点=$10）' : 'Trading BTC/USDT (standard lot pip value=$10)'}</li>
              ...
              <p className="text-sm mt-2">
                {isZh
                  ? '实际交易中可开0.6或0.7标准手，或使用BiKiller仓位计算器自动计算。'
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <p className="text-gray-700 dark:text-gray-300">
              {isZh
                ? '日内交易不是快速致富的捷径，而是一项需要技能、纪律和耐心的职业。大多数新手在前6-12个月会亏损，这是正常的学习成本。建议：1) 从模拟账户开始，至少练习3个月；2) 初期使用小仓位（0.01手），积累经验；3) 专注于一种策略和2-3个交易对，不要贪多；4) 每天复盘，持续改进；5) 加入交易社区，向经验丰富的交易者学习。记住：在交易中生存下来比暴富更重要。'
