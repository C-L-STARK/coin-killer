          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <ul className="space-y-3">
              <li>
                ...
                {isZh
                  ? '即使设置了止损，如果仓位过大（如满仓），单次止损仍可能导致账户重创或爆仓。正确的仓位控制确保即使连续止损，账户仍有回旋余地。例如，$10,000账户开10手BTC/USDT，止损30点就亏$3,000（30%）；但开0.67手，止损30点只亏$200（2%）。'
          ...
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300 text-sm">
              ...
              <li>
                ...
                {isZh ? '所有交易对用相同手数，高波动性交易对（GBP/JPY）风险是低波动性（EUR/CHF）的3-5倍，导致实际风险失控。' : 'Same lot size for all pairs, high volatility pairs (GBP/JPY) risk 3-5x low volatility (EUR/CHF), causes actual risk loss of control.'}
              </li>
              <li>
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800">
                ...
                <p className="text-sm">
                  {isZh
                    ? '根据市场波动性（ATR）、账户表现、交易时段、交易对特性等因素动态调整仓位。最灵活，但也最复杂。适合职业交易者或使用自动化工具的交易者。'
      ...
      <section id="fixed-fractional" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
              ...
              <div className="space-y-3 text-sm">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    ...
                    {isZh ? 'BTC/USDT标准手$10/点，迷你手$1/点，微型手$0.1/点。不同交易对略有差异。' : 'BTC/USDT standard lot $10/pip, mini lot $1/pip, micro lot $0.1/pip. Varies slightly by pair.'}
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-black dark:border-white">
              <h3 className="text-lg font-bold mb-3 text-black dark:text-white">
                {isZh ? '实例1：BTC/USDT日内交易' : 'Example 1: BTC/USDT Day Trade'}
              </h3>
              <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <div className="p-3 bg-gray-50 dark:bg-gray-800">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>{isZh ? '交易对：BTC/USDT' : 'Pair: BTC/USDT'}</li>
              ...
              <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                <div className="p-3 bg-gray-50 dark:bg-gray-800">
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li>{isZh ? '交易对：GBP/JPY' : 'Pair: GBP/JPY'}</li>
      ...
      <section id="kelly-criterion" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              {isZh
                ? '凯利公式（Kelly Criterion）由数学家约翰·凯利于1956年提出，原用于信息论，后被应用于赌博和投资领域。它通过计算最优仓位百分比，理论上实现账户最快增长。在数字货币交易中，凯利公式可以帮助我们根据策略的历史表现（胜率和盈亏比）确定科学的仓位大小。'
      ...
      <section id="dynamic-sizing" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
            <p>
              {isZh
                ? '动态仓位调整是最灵活的仓位控制方法，根据市场波动性、账户表现、交易时段、交易对特性等多个因素实时调整仓位大小。这种方法可以最大化资金利用效率，同时适应不断变化的市场环境。适合职业交易者或使用自动化交易系统的交易者。'
            ...
            <div className="p-6 border-2 border-black dark:border-white">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-4 bg-gray-50 dark:bg-gray-800">
                  ...
                  <p className="font-bold mb-2">{isZh ? '示例：BTC/USDT交易' : 'Example: BTC/USDT Trading'}</p>
                  <ul className="list-disc pl-6 space-y-1">
            ...
            <div className="p-6 border-2 border-black dark:border-white">
              <h3 className="text-xl font-bold mb-4 text-black dark:text-white">
                {isZh ? '方法4：基于交易对特性的差异化' : 'Method 4: Currency Pair Characteristic Differentiation'}
              </h3>
              <div className="space-y-3 text-sm">
                <p>
                  {isZh
                    ? '不同交易对的波动性、点差、流动性差异巨大。高波动性交易对（如GBP/JPY）应该使用更小仓位，低波动性交易对（如EUR/CHF）可以适度增加。'
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-2 border-black dark:border-white">
                    ...
                    <tbody>
                      <tr>
                        <td className="border border-black dark:border-white p-3">
                          {isZh ? '主要交易对' : 'Major Pairs'}
                        </td>
                        <td className="border border-black dark:border-white p-3 font-bold">1.0×</td>
                        <td className="border border-black dark:border-white p-3">BTC/USDT, ETH/USDT, USD/JPY</td>
                      </tr>
                      <tr className="bg-gray-50 dark:bg-gray-800">
                        <td className="border border-black dark:border-white p-3">
          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="list-disc pl-6 space-y-1">
                ...
                <li>{isZh ? '交易对：GBP/JPY（高波动）' : 'Pair: GBP/JPY (high volatility)'}</li>
      ...
      <section id="common-mistakes" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          {[
            ...
            {
              title: isZh ? '错误4：所有交易对用相同仓位' : 'Mistake 4: Same Position for All Pairs',
              problem: isZh
                ? 'BTC/USDT和GBP/JPY都开1手。但GBP/JPY波动性是BTC/USDT的2-3倍，实际风险差异巨大。'
                : 'Open 1 lot for both BTC/USDT and GBP/JPY. But GBP/JPY volatility is 2-3x BTC/USDT, actual risk difference huge.',
              solution: isZh
                ? '使用ATR或交易对特性调整仓位。高波动性交易对减少20-50%仓位，确保所有交易的实际风险金额相同（如都是$200）。'
            ...
            },
            {
              ...
              problem: isZh
                ? '账户从$10,000亏至$7,000，仍开1手BTC/USDT。实际单笔风险从2%增至2.8%，风险失控。'
                : 'Account loses from $10,000 to $7,000, still open 1 lot BTC/USDT. Actual per-trade risk increases from 2% to 2.8%, risk out of control.',
              solution: isZh
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <p>
                {isZh
                  ? '避免同时持有高度相关的交易对，防止风险集中。例如同时做多BTC/USDT、ETH/USDT、AUD/USD，实际风险远超单笔2%。'
          ...
          <div className="p-6 bg-black dark:bg-white text-white dark:text-black">
            ...
            <div className="space-y-3 text-sm">
              ...
              <ul className="space-y-2">
                <li>
                  <strong>{isZh ? '1. BiKiller Position Calculator：' : '1. BiKiller Position Calculator:'}</strong>{' '}
                  {isZh
                    ? '输入账户、风险%、止损点数，自动计算手数。支持所有交易对，自动获取实时每点价值。'
