    ...
    <EducationPageTemplate content={content} language={lang}>
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-800">
                ...
                <ul className="list-disc pl-6 space-y-1 text-sm">
                  ...
                  <li>{isZh ? '交易BTC/USDT，止损30点' : 'Trading BTC/USDT, stop-loss 30 pips'}</li>
      ...
      <section id="position-sizing-basics" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  ...
                  {isZh
                    ? 'BTC/USDT标准手每点$10，迷你手$1，微型手$0.1'
                    : 'BTC/USDT standard lot $10/pip, mini lot $1/pip, micro lot $0.1/pip'}
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-6 border-2 border-black dark:border-white">
              <h3 className="text-lg font-bold mb-3 text-black dark:text-white">
                {isZh ? '示例1：BTC/USDT交易' : 'Example 1: BTC/USDT Trade'}
              </h3>
            ...
            <div className="p-6 border-2 border-black dark:border-white">
              ...
              <div className="space-y-2 text-sm">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  ...
                  <li>{isZh ? '交易对：GBP/JPY（每点约$6.8）' : 'Pair: GBP/JPY (pip value ~$6.8)'}</li>
                </ul>
                <p className="font-bold mt-3">{isZh ? '计算过程：' : 'Calculation:'}</p>
                <div className="p-3 bg-gray-100 dark:bg-gray-800 font-mono text-xs">
                  {isZh
          ...
          <div className="p-6 border-2 border-black dark:border-white">
            ...
            <ul className="space-y-3">
              ...
              <li>
                ...
                <p className="text-sm mt-1">
                  {isZh
                    ? '认为所有交易对每点价值都是$10。实际上，GBP/JPY、AUD/CAD等交叉盘每点价值不同，且随汇率波动。必须使用计算器或查询交易所数据。'
                    : 'Assuming all pairs have $10 pip value. Actually, cross pairs like GBP/JPY, AUD/CAD have different pip values that fluctuate with exchange rates. Must use calculator or check exchange data.'}
                </p>
              </li>
              <li>
                <strong className="text-red-600 dark:text-red-400">
          ...
          <div className="p-6 bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-600">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              ...
              <li>
                ...
                {isZh
                  ? '高波动性交易对（GBP/JPY）容易达成大目标，可用1:3；低波动性（EUR/CHF）用1:1.5-1:2'
      ...
      <section id="common-mistakes" className="mb-16 scroll-mt-20">
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-red-50 dark:bg-red-900/20 border-2 border-red-600">
            <h3 className="text-lg font-bold mb-3 text-black dark:text-white">
              ❌ {isZh ? '错误4：忽视相关性，同时交易多个相关交易对' : 'Mistake 4: Ignoring Correlation, Trading Multiple Correlated Pairs'}
            </h3>
            <p className="text-gray-700 dark:text-gray-300 mb-2">
              {isZh
                ? '同时做多BTC/USDT、ETH/USDT、AUD/USD，认为是"分散风险"。实际上，这三个交易对高度相关（都对美元），一旦美元走强，三笔交易同时亏损，实际风险6-8%。'
                : 'Simultaneously long BTC/USDT, ETH/USDT, AUD/USD, thinking it\'s "risk diversification". Actually, these three pairs highly correlated (all against USD), once USD strengthens, all three trades lose, actual risk 6-8%.'}
            </p>
            <p className="text-green-600 dark:text-green-400 font-bold">
              ✅ {isZh ? '正确做法：' : 'Solution:'}{' '}
              {isZh
